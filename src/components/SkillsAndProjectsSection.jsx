...
const SkillCard = ({ skill, icon: Icon, level, badges }) => (
  <div className="transform transition-all duration-300 hover:scale-105">
    <div className="bg-primary rounded-xl p-6 m-2 h-[220px] flex flex-col justify-between">
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          <div className="p-2 rounded-lg bg-accent/10">
            <Icon className="w-6 h-6 text-accent" />
          </div>
          <h3 className="text-lg font-medium text-background">{skill}</h3>
        </div>
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center">
          <span className="text-sm text-background/70">Proficiency</span>
...
const ProjectCard = ({ project }) => (
  <div className="group relative overflow-hidden rounded-xl">
    ...
    <div className="absolute bottom-0 left-0 right-0 p-6 bg-primary translate-y-[70%] group-hover:translate-y-0 transition-transform duration-500">
      <h3 className="text-xl font-semibold text-background mb-2">{project.title}</h3>
      <p className="text-background/70 mb-4">{project.description}</p>
  ...
  return (
    <section className="py-16">
      <div className="mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl md:text-5xl font-circular-web font-bold text-primary mb-4">My Skills</h2>
        ...
        <div className="pt-10">
          <h2 className="text-3xl font-circular-web font-bold text-primary mb-4">Featured Projects</h2>
          <p className="text-primary col-secondary mb-8">Showcase of my recent work and personal projects</p>
