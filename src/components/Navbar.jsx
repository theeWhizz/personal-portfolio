  ...
  return (
    <div>
      <div className="navbar flex-between bg-primary px-5 py-3 rounded-lg">
        <div>
          <h1 className="font-zentry text-2xl special-font text-secondary">. / . <b>blenick</b></h1>
        </div>
        ...
        >
          <div
            className={`
              absolute pt-2 pb-5 -z-10 rounded-3xl transition-all duration-300 ease-in-out bg-accent
            `}
            style={{
          ...
          <div
            className={`
              absolute pt-3 pb-3 rounded-3xl transition-all duration-300 ease-in-out bg-secondary
            `}
            style={{
              width: indicatorStyle.width,
              left: indicatorStyle.left,
